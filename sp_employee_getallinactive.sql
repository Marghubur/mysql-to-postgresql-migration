DROP PROCEDURE IF EXISTS public.sp_employee_getallinactive(character varying, character varying, integer, integer, jsonb);
DROP FUNCTION IF EXISTS public.sp_employee_getallinactive(character varying, character varying, integer, integer);

CREATE OR REPLACE PROCEDURE public.sp_employee_getallinactive(
