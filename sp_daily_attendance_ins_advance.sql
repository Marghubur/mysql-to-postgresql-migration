CREATE OR REPLACE PROCEDURE public.sp_daily_attendance_ins_advance(
...
BEGIN
 ...
 where
 date_add(_fromdate, (seq - 1) * interval '1 day') <= _todate
 and not exists (
 select 1 
 from daily_attendance da 
 where da.employeeid = e.employeeuid 
...
EXCEPTION WHEN OTHERS THEN
  ...
  CALL public.sp_logexception(_message, '', 'sp_daily_attendance_ins_advance', 1::bit, 0::bit, _result);
END;
$$;
