CREATE OR REPLACE PROCEDURE public.sp_company_calender_getby_filter(
...
EXCEPTION WHEN OTHERS THEN
  ...
  CALL public.sp_logexception(_message, '', 'sp_company_calender_getby_filter', 1::bit, 0::bit, _result);
END;
$$;
