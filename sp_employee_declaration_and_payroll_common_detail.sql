DROP PROCEDURE IF EXISTS public.sp_employee_declaration_and_payroll_common_detail(jsonb);

CREATE OR REPLACE PROCEDURE public.sp_employee_declaration_and_payroll_common_detail(
